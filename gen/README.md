...
Admin API
- API version: 3.0.0
  - Build date: 2023-03-01T01:39:46.309877285+05:00[Asia/Yekaterinburg]
...
------------ | ------------- | ------------- | -------------
*DefaultApi* | [**userPatch**](docs/DefaultApi.md#userPatch) | **PATCH** /user/ | Изменение настроек пользователя по Id
